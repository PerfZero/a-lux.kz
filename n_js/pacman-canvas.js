...
function geronimo() {
    ...
    function Game() {
        ...
        this.newGame = function() {
            var r = confirm("Вы уверены, что хотите начать новую игру?");
            if (r) {
        ...
        this.nextLevel = function() {
            this.level++;
            console.log("Уровень " + game.level);
            game.showMessage("Уровень " + game.level, this.getLevelTitle() + "<br/>(Нажмите для продолжения)");
        ...
        this.getLevelTitle = function() {
            switch(this.level) {
                case 2:
                    return 'Охота началась. Пройдите ещё один уровень<br />и получите скидку 10% на наши услуги!';
                // activate chase / scatter switching
                case 3:
                    return 'Позвоните, назовите кодовое слово «ФЕЛИКС»<br />и скидка в 10% ваша!<br />Либо играйте дальше и получите скидку в 15%!';
                // Inky starts leaving the ghost house
                case 4:
                    return 'Ещё один уровень и вы у цели!';
                // Clyde starts leaving the ghost house
                case 5:
                    return 'Позвоните, назовите кодовое слово «КАЛИТА»<br />и скидка в 15% ваша!';
                // All the ghosts get faster from now on
                /*
                case 6:
                    return '"Сезон охоты 1"';
                    // TODO: No scatter mood this time
                case 7:
                    return '"Большое спокойствие"';
                    // TODO: Only scatter mood this time
                case 8:
                    return '"Сезон охоты 2"';
                    // TODO: No scatter mood and all ghosts leave instantly
                case 9:
                    return '"Быстрые призраки"';
        ...
        this.pauseResume = function () {
            if (!this.running) {
                ...
                this.showMessage("Пауза", "Кликните для продолжения");
            }
        };
    ...
    function pacman() {
        ...
        this.dieFinal = function() {
            ...
            if (this.lives <= 0) {
                ...
                game.showMessage("Игра окончена", "Всего очков: " + game.score.score); // + input
                game.gameOver = true;
                $('#playerName').focus();
            }
